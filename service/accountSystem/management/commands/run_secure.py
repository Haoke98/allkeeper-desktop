...
if (sys.version_info[0] > 3) or     (sys.version_info[0] == 3 and sys.version_info[1] >= 6) or     (sys.version_info[0] == 3 and sys.version_info[1] == 5 and sys.version_info[2] >= 3) or     (sys.version_info[0] == 2 and sys.version_info[1] == 7 and sys.version_info[2] >= 13):
...
def default_ssl_files_dir():
    # Use django-sslserver certs if available, otherwise check local
    try:
        ...
        # Fallback if sslserver not installed
